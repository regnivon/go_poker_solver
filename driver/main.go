...
func main() {
	...
	//oopHands := "AA, KK, QQ, JJ, TT, 99, 88, 77, KQ, QJ, JT, T9, 98"
	//ipHands := "AA, KK, QQ, JJ, TT, 99, 88, 77, KQ, QJ, JT, T9, 98"
	...
	params := solv.NewConstructionParams(1.0, 1.2)
	tree := solv.ConstructTree(400, 4000, params, ip, oop, board)
